...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {		// Initialization code
        ...
        self.lblStaticPurchased = [[UILabel alloc] initWithFrame:CGRectMake(143, 28, 68, 15)];
        ...
        self.lblStaticPurchased.text =  @"Purchased:";
        [myContentView addSubview:self.lblStaticPurchased];

        // static purchased label
        self.lblDate = [[UILabel alloc] initWithFrame:CGRectMake(213, 28, 70, 15)];
